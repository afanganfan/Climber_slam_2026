...
def generate_launch_description():
    ...
    climber_ws_launch_dir = os.path.join(get_package_share_directory('pb_rm_simulation'), 'launch')
    ...
    start_rm_simulation = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(climber_ws_launch_dir, 'rm_simulation.launch.py')),
        launch_arguments={
